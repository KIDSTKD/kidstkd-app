  ...
  return (
    <>
      ...
      <ul>
        ...
        <li>анкета занимающегося в спортивной секции тхэквондо, которую можно <Link href='/02-docs/07-other'>скачать</Link> и заполнить самостоятельно;</li>
