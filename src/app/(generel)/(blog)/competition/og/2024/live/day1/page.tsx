...
export default function OG2024() {
   return (
      <>
         ...
         <iframe src="https://vk.com/video_ext.php?oid=-211669815&id=456245015&hd=2&autoplay=1" width="853" height="480" allow="autoplay; encrypted-media; fullscreen; picture-in-picture; screen-wake-lock;" frameborder="0" allowfullscreen></iframe>
