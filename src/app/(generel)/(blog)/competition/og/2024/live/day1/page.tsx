...
export default function OG2024() {
   return (
      <>
         ...
         <p>Возможны перебои в прамой трансляции. Трансляция также доступна на сайте <LinkSpan text={"olympics.com"} href={"https://olympics.com/en/paris-2024/videos/women-s-49kg-men-s-58kg-round-of-16-taekwondo-olympic-games-paris-2024"} />  (необходима авторизация)</p>
